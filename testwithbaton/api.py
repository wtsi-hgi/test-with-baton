...
class BatonSetup(Enum):
    ...
    v0_16_3_PRE_WITH_IRODS_3_3_1 = (BatonImage("mercury/baton:0.16.3-pre-with-irods-3.3.1"), IrodsVersion.v3_3_1)
    v0_16_3_PRE_WITH_IRODS_4_1_8 = (BatonImage("mercury/baton:0.16.3-pre-with-irods-4.1.8"), IrodsVersion.v4_1_8)
